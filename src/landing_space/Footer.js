    ...
    <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            <p>Company</p>
              ...
              <br />
              <a href="#"  className="text-muted" style={{ textDecoration: "none" }}>ZerodhaCares (CSR)</a>
          ...
          <div className="col">
            <p>Account</p>
            <a href="#"  className="text-muted" style={{ textDecoration: "none" }}>Open anaccount</a>
            <br />
            <a href="#"  className="text-muted" style={{ textDecoration: "none" }}>Fund tranfer</a>
          </div>
        </div>
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
         ...
         <div className="row">
             <div className="col" ><a href="#" className="text-black" style={{ textDecoration: "none" }}>NSE</a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>BSE</a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>MCX</a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>Terms & Conditions</a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>Policies & Procedure</a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>Privacy Policy </a></div>
             <div className="col"><a href="#" className="text-black" style={{ textDecoration: "none" }}>Disclosure</a></div>
